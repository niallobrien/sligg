// npm i --save-dev gulp gulp-sass gulp-autoprefixer gulp-cssnano gulp-rename gulp-size gulp-uglify gulp-util browser-sync browserify babelify watchify del vinyl-source-stream vinyl-buffer gulp-notify babel-preset-es2015 tether
...
function buildScript(file, watch) {
  ...
  var bundler = watch ? watchify(browserify('./resources/scripts/' + file)) : browserify('./resources/scripts/' + file);
